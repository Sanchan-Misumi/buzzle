...
class ViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout{
    ...
    //UICollectionViewDelegateはコレクションビューの中の動きを管理
    //UICollectionViewDelegateFlowLayoutはコレクションビューの中の見た目の間隔を決める
    ...
    @objc func handleGesture(sender: UISwipeGestureRecognizer) {
        ...
        if sender.direction == .right {
            ...
            tmpImage = collectionView.cellForItem(at: toIndexPath)?.imageView.image
            collectionView.cellForItem(at: toIndexPath)?.imageView.image = collectionView.cellForItem(at: atIndexPath)?.imageView.image
            collectionView.cellForItem(at: atIndexPath)?.imageView.image = tmpImage
    ...
    //UICollectionViewDataSourceはコレクションビューの中のデータと見た目
    //セクション内のセルの個数
